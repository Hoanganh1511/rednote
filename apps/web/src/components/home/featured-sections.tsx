...
/**
 * Hero + lưới phụ: từ `lg` dùng **5 cột** (2 cột hero × 2 hàng + 3×2 ô video).
 */
export function FeaturedVideoSection() {
  return (
    <section aria-label="Video nổi bật">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5 lg:grid-rows-2">
        <div className="relative col-span-2 overflow-hidden rounded-xl sm:col-span-3 lg:col-span-2 lg:row-span-2">
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-b-xl bg-gradient-to-t from-black/70 to-transparent p-3">
            <p className="line-clamp-2 text-sm font-semibold text-white">Video nổi bật sẽ hiển thị ở đây</p>
...
/** Lưới video mới: PC **5 cột** từ `lg`. */
export function LatestVideosSection() {
  return (
    <section aria-label="Video mới nhất">
